...
const CarBuyingGuides = () => {
  ...
  return (
    <div
      className="h-screen bg-[#00000046] bg-blend-overlay bg-no-repeat bg-center bg-fixed overflow-scroll py-10 my-10"
